    ...
    <div className="container mx-auto py-12 px-4">
      ...
      <Card className="mb-8">
        ...
        <CardContent>
          ...
          <ol className="list-decimal list-inside space-y-2">
            ...
            <li>Choose between uploading a pre-existing transcript or providing a Zoom link.</li>
            <li>Add any custom instructions or specify people to omit from the analysis.</li>
      ...
      <Card className="mb-8">
        ...
        <CardContent>
          ...
          <ol className="list-decimal list-inside space-y-2">
            <li>Sign up for a Kwill account at <Link href="/public/signup" className="text-blue-600 hover:underline">our signup page</Link>.</li>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li><strong>Is my meeting data secure?</strong> Yes, we use encryption for all data in transit and at rest. We only retain transcripts for 30 days.</li>
